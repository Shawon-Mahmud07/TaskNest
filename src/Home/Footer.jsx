        ...
        <div className="max-w-screen-2xl mx-auto ">
          <div className="grid grid-cols-1 justify-between  md:grid-cols-3">
            <div className="flex flex-col justify-center items-center ">
              <div>
                <div className="flex gap-2 items-center text-white cursor-pointer">
                  ...
                  <h1 className="font-cinzel text-3xl lg:text-3xl font-semibold">
              ...
              <div className=" w-10/12 mx-auto lg:mx-0 flex justify-center lg:justify-end ">
                <div className="max-w-sm text-center">
                  ...
                  <div className="space-y-1 font-cinzel">
                    <h4>789 QRS Avenue, Suite 42, Canada</h4>
                    <p>+1 987-654-3210</p>
                    <p>Sat - Sun: 09:00 AM - 10:00 PM</p>
                    <p>Mon - Fri: 08:30 AM - 09:30 PM</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="  flex justify-end items-center ">
              <div className="  w-9/12 mx-auto lg:mx-0 flex justify-center lg:justify-start">
